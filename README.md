...
React's useRouteMatch hook is used to add nested routes to your application so you can change a parameter in the URL instead of changing the whole URL.

1. How would you explain form validation to someone who has never programmed before?
Form validation is a way to ensure that the data a user submits is valid before submitting a form. For example, making sure that a phone number matches the correct phone number format.

1. In 1-2 sentences, define end to end testing.
End-to-end testing is testing an entire flow of how a user interacts with a part of an application from start to finish.
